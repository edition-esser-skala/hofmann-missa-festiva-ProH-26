...
BenedictusBasso = {
  \relative c {
    ...
    R1*5 %5
    \mvTr h'2\fE^\tuttiE fis
    d4 cis8 h g'2
    fis4 r8 fis dis([ fis)] h, a'!
    g8. fis16 e8 e cis([ e)] a, g'
    fis8. e16 d8 d' h[( g16. h32] g8[ e16. g32] %10
    cis,8) d16 d a8. a16 d4 r
    R1*5 %16
    d'2 a
    fis4 e8 d h'2
    a4 r8 a ais cis16 ais fis8 e16 fis
    d8. cis16 h8 h' e, fis16([ g)] a8 h16([ cis)] %20
    d8 d, r g cis, d16([ e)] fis8 gis16([ ais)]
    h8 h, r h' d h16 h g8. g16
    fis8 fis d cis16 h fis'4. fis8
    h, h' g[ h16. g32] e8[ g16. e32] cis8[ e16. cis32]
    ais8 h16 h fis'8. fis16 h,4 r %25
    R1*2
    r4 r8 \tempoOsanna r r4 r8 dis
    e e r4 r r8 cis
    d! d r d g4 g %30
    fis cis d8 e fis d
    a2 d4 d8 d
...
BenedictusBassoLyrics = \lyricmode {
  ...
  Do -- mi -- ni, qui ve -- nit, be -- ne -- %20
  di -- ctus, qui ve -- nit, be -- ne --
  di -- ctus, in no -- mi -- ne Do -- mi --
...
AgnusBasso = {
  \relative c {
    ...
    a4 d~ d16[ cis h a] gis8[ fis16 gis]
    a4. g8 fis[ e] d4 %45
    ...
    h8[ d'16 cis] h[ a gis fis] e8 a e4
    a,8 a'([ gis]) d' cis a gis d' %55
    cis a e4 a, r
    R1*5 %51
    d2 g
    fis4 h cis, a'8[ g]
    ...
    cis8[ e16 d] cis[ h ais gis] fis8 h fis'4
    h,8 h([ ais]) e' d h ais[( e']
    d) h fis'4 h, r %75
    R1*2
    r2 d
    g fis4 d
    r8 fis16[ e] fis8[ gis] a4 d~ %80
    ...
    a~ %85
    a2 d4 r8 d
    e[ g16 fis] e[ d cis h] a8 d a4
    d r r2
    R1*2
    r8 d([ cis)] g' fis d cis([ g'] %91
    fis) d a4 d a
